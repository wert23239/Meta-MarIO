...
set_target_properties(TH PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/install/TH.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "C:/torch/lapack/lib/libblas.lib;C:/torch/lapack/lib/liblapack.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/install/TH.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS TH )
list(APPEND _IMPORT_CHECK_FILES_FOR_TH "${_IMPORT_PREFIX}/install/TH.lib" "${_IMPORT_PREFIX}/install/TH.dll" )
